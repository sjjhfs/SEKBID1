      ...
      >
        <div
          className={cn(
            ...
            // FIXED: Overlay behavior - the spacer always stays at icon width on desktop
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      {...props}
    >
      <PanelLeft className={cn("h-5 w-5 transition-transform duration-300", state === "expanded" && "rotate-180")} />
